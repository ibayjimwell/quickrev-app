...
import { Search, ChevronDown, FileText, Eye, RefreshCw, Loader2 } from 'lucide-react';
...
function ReviewerSection() {
    ...
    const handleOpenReviewer = (reviewer) => {
        console.log(`Opening Reviewer for File ID: ${reviewer.file_id}`);
        // TODO: Implement navigation to the /review/{file_id} route
        alert(`Navigating to Reviewer: ${reviewer.name}`);
    };
                ...
                sortedReviewers.map((reviewer) => (
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-2 flex-shrink-0 mt-3 sm:mt-0 items-center">
                            ...
                            >
                                <Eye className="w-4 h-4 mr-2" /> View Reviewer
                            </button>
                        </div>
                    </div>
                ))
